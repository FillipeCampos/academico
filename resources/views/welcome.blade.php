   ...
   <div class="hero-content-overlay">
                ...
                <div class="col-12 col-lg-6 flex align-content-center mt-5 mt-lg-0">
                    <div class="ezuca-video position-relative">
                        <div class="video-play-btn position-absolute">
                            <img src="{{ asset('images/video-icon.png') }}" alt="Video Play">
                        </div><!-- .video-play-btn -->

                        <img src="{{ asset('images/video-screenshot.png') }}"  alt="">
                    </div><!-- .ezuca-video -->
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container -->
                ...
                <div class="col-12 col-lg-6">
                    <div class="featured-event-content">
                        <figure class="event-thumbnail position-relative m-0">
                            <a href="#"><img src="{{ asset('images/event-1.jpg') }}" alt=""></a>
                ...
                <div class="col-12 col-lg-6 mt-5 mt-lg-0">
                    <div class="event-content flex flex-wrap justify-content-between align-content-stretch">
                        <figure class="event-thumbnail">
                            <a href="#"><img src="{{ asset('images/event-2.jpg') }}" alt=""></a>
                        </figure><!-- .course-thumbnail -->
                    ...
                    <div class="event-content flex flex-wrap justify-content-between align-content-lg-stretch">
                        <figure class="event-thumbnail">
                            <a href="#"><img src="{{ asset('images/event-3.jpg') }}" alt=""></a>
                        </figure><!-- .course-thumbnail -->
    ...
    <section class="home-gallery">
        <div class="gallery-wrap flex flex-wrap">
            ...
            <div class="gallery-grid gallery-grid2x1">
                <a href="#"><img src="{{ asset('images/h.jpg') }}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid1x1">
                <a href="#"><img src="{{ asset('images/i.jpg') }}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid2x2 ">
                <a href="#"><img src="{{ asset('images/j.jpg') }}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid1x1">
                <a href="#"><img src="{{ asset('images/k.jpg') }}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid1x1">
                <a href="#"><img src="{{ asset('images/l.jpg') }}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid2x1">
                <a href="#"><img src="{{ asset('images/m.jpg') }}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid3x1">
                <a href="#"><img src="{{ asset('images/n.jpg') }}" alt=""></a>
            </div><!-- .gallery-grid -->

            <div class="gallery-grid gallery-grid1x1">
                <a href="#"><img src="{{ asset('images/o.jpg') }}" alt=""></a>
            </div><!-- .gallery-grid -->
        </div><!-- .gallery-wrap -->
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="foot-about">
                            <a class="foot-logo" href="#"><img src="{{ asset('images/foot-logo.png') }}" alt=""></a>
                ...
                <div class="row flex-wrap justify-content-center justify-content-lg-between align-items-center">
                    <div class="col-12 col-lg-6">
                        <div class="download-apps flex flex-wrap justify-content-center justify-content-lg-start align-items-center">
                            ...
                            <a href="#"><img src="{{ asset('images/play-store.png') }}" alt=""></a>
                        </div><!-- .download-apps -->
